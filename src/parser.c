...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_project] = STATE(90),
    [sym_project_open] = STATE(7),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_item_group_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_item_group_repeat1, 2, 0, 0),
  [16] = {.entry = {.count = 1, .reusable = false}}, SHIFT(42),
  [18] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [20] = {.entry = {.count = 1, .reusable = false}}, SHIFT(45),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_property_group_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_property_group_repeat1, 2, 0, 0),
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_project_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_project_repeat1, 2, 0, 0),
  ...
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_package_reference_openclose_repeat1, 2, 0, 0),
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_package_reference_openclose_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_package_reference_openclose_repeat1, 2, 0, 0), SHIFT_REPEAT(73),
  ...
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_project_reference_openclose_repeat1, 2, 0, 0),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_project_reference_openclose_repeat1, 2, 0, 0), SHIFT_REPEAT(76),
  ...
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_non_empty_attributes_repeat1, 2, 0, 0),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_non_empty_attributes_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_non_empty_attributes, 1, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_non_empty_attributes, 2, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_reference_version_attribute, 3, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_reference_include_attribute, 3, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_value, 3, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_project_open, 3, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_open, 3, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_project_open, 4, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_open, 4, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_group_open, 3, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_group_open, 3, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_group_open, 3, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_group_open, 3, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_group, 2, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_group, 2, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_generic_element, 2, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_generic_element, 2, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_group, 3, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_group, 3, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_group, 3, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_group, 3, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 3, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_non_empty_attributes_repeat1, 2, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_reference_include_attribute, 3, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_group_open, 4, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_group_open, 4, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 3, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_open, 3, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_group_close, 3, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_group_close, 3, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_framework, 3, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_framework, 3, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_generic_element, 3, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_generic_element, 3, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_reference_openclose, 3, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_reference_openclose, 3, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_project_reference_openclose, 3, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_reference_openclose, 3, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_group_close, 3, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_group_close, 3, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_open, 4, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_open, 4, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tag_close, 3, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_close, 3, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_reference_openclose, 4, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_reference_openclose, 4, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_project_reference_openclose, 4, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_reference_openclose, 4, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_group, 2, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_group, 2, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute_value, 3, 0, 0),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_target_framework_close, 3, 0, 0),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_framework_close, 3, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_reference, 1, 0, 0),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_reference, 1, 0, 0),
  [218] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_project_reference, 1, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_reference, 1, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_property_group_open, 4, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property_group_open, 4, 0, 0),
  [226] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project, 2, 0, 0),
  ...
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project_close, 3, 0, 0),
  [262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [264] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_target_framework_open, 3, 0, 0),
  ...
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_project, 3, 0, 0),
